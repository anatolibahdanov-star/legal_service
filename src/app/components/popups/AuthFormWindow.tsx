...
export function AuthFormWindow({ isOpen, onClose, onSwitchToRegister, onSwitchToReset }: AuthWindowProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <AuthForm onSwitchToRegister={onSwitchToRegister} onSwitchToReset={onSwitchToReset} onClose={onClose} />
      </div>
    </div>
  );
}