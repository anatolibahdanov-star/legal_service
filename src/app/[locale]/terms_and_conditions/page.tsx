    ...
    <>
      ...
      <main className="flex-1 w-full max-w-[1216px] mx-auto px-[159px] py-[48px]">
        <div className="mb-[32px]">
          ...
          <p className="text-[20px] leading-[28px] text-[rgba(41,40,43,0.7)] text-center">
            компании «ЮристПро»
          </p>
        </div>
        ...
        <div className="bg-white rounded-[16px] p-[48px]">
          <div className="space-y-[32px]">
            <p className="text-[16px] leading-[26px] text-[rgba(41,40,43,0.9)]">
            ...
            {/* Section 1 */}
            <section>
              <h2 className="font-bold text-[30px] leading-[36px] text-[#29282b] mb-[16px]">
                1. Общие положения
              </h2>
            ...
            <section>
              ...
              <div className="space-y-[12px] pl-[28px] border-l-4 border-[#8faaba]">
                ...
                <ul className="space-y-[8px]">
                  <li className="text-[16px] leading-[24px] text-[rgba(41,40,43,0.8)] flex items-start">
                ...
                <p className="text-[16px] leading-[26px] text-[rgba(41,40,43,0.9)] mt-[16px]">
